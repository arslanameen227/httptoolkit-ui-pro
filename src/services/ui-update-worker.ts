...
// Firebase is disabled in service worker to avoid network issues in development
// Only logError is imported for error reporting
...
interface ServiceWorkerGlobalScopeWithManifest {
...
function getPrecacheController(): PrecacheController {
...
async function precacheNewVersionIfSupported(event: any) {
