...
export default merge(common, {
    ...
    devServer: {
        ...
        hot: true,
        liveReload: false, // Disable live reload to reduce disconnections
        client: {
            overlay: {
                runtimeErrors: (error) => {
                    const IGNORED_RUNTIME_ERRORS = [
                        ...
                        'Monaco editor failed to load' // Ignore Monaco loading errors in overlay
                    ];
            ...
            reconnect: 5, // Number of reconnect attempts
